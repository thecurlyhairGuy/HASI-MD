...
let cc = Config.sessionName.replace(/HASI-MD;;;/g, "");
...
<html>
  ...
  <body>
    <section>
      Hello from naveeddogar g!
    </section>
  </body>
</html>
`
app.get("/", (req, res) => res.type('html').send(html));
app.listen(port, () => console.log(`HASI-MD Server listening on port http://localhost:${port}!`));
